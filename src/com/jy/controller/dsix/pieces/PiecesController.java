...
public class PiecesController extends BaseController<Pieces> {
	...
	@ResponseBody
	public AjaxRes findByPage(Page<Pieces> page,String kfName,String  beginTime,String  endTime){
		AjaxRes ar=getAjaxRes();
		if(ar.setNoAuth(doSecurityIntercept(Const.RESOURCES_TYPE_MENU,"/backstage/pieces/index"))){
			try {
				Pieces piece=new Pieces();
				piece.setTitle(kfName);
				piece.setBeginTime(DateUtils.parseDate(beginTime));
				piece.setEndTime(DateUtils.parseDate(endTime));
				Page<Pieces> imess=service.findByPage(piece, page);
