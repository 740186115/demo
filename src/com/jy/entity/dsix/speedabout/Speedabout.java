...
public class Speedabout    extends BaseEntity {
    ...
    private Integer speedorder;

    private String speedhomepage;

    private String speedfriendstand;
    ...
    public Integer getspeedorder() {
        return speedorder;
    }

    public void setspeedorder(Integer speedorder) {
    ...
    public String getspeedfriendstand() {
        return speedfriendstand;
    }

    public void setspeedfriendstand(String speedfriendstand) {
        this.speedfriendstand = speedfriendstand;
    }
